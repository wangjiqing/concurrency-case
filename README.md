...
59. [ThreadPool之newFixedThreadPool的使用](src/main/java/com/sakura/concurrencycase/example/threadpool/ThreadPoolExample2.java) 
60. [ThreadPool之newSingleThreadPool的使用](src/main/java/com/sakura/concurrencycase/example/threadpool/ThreadPoolExample3.java)
61. [ThreadPool之newScheduledThreadPool的使用](src/main/java/com/sakura/concurrencycase/example/threadpool/ThreadPoolExample4.java) 